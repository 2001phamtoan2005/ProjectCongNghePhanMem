  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" onclick="addposition"><i class="fas fa-plus mr-1"></i> Create </button>
        &nbsp;
...
<div class="modal" id="DelModal">
  <div class="modal-dialog">
    ...
    ?>
    <form class="" action="<?=base_url('position') ?>" method="get">
            <div class="row g-3">
                <div class="col-md-6">
                    <label for="inputEmail1" class="form-label"><?php echo lang('component.NamePosition'); ?></label>
                    <input type="text"  name="name" class="form-control" id="name">
                ...
                <div class="col-md-12 d-flex justify-content-end mt-5">
                    ...
                    &emsp;
                    <button type="submit" formaction="<?php echo base_url('position/export') ?>" class="btn btn-success" type="submit"
...
$(document).ready(function() {
    var t=$('#tableuser').DataTable({
        ...
        orderable: true,
            ...
            ajax: {
                "url": "<?php echo base_url('position/searchposition')?>",
                "type": "GET",
                "datatype": "json",
                "data": {
    ...
    $('#tableuser tbody').on( 'click', '#delBtn', function () {
        ...
        //+'<a href="javascript:;" class="EditBtn"  > Edit</a></td>'
    ...
    $('#createForm').submit(function(e){
        ...
        $.ajax({
        url: "<?=base_url('position/addposition') ?>",
        type: "POST",
